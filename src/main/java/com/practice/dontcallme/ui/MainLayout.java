package com.practice.dontcallme.ui;


import com.practice.dontcallme.backend.example.TestView;
import com.practice.dontcallme.ui.components.layout.FlexBoxLayout;
import com.practice.dontcallme.ui.components.navigation.bar.AppBar;
import com.practice.dontcallme.ui.components.navigation.bar.TabBar;
import com.practice.dontcallme.ui.components.navigation.drawer.NaviDrawer;
import com.practice.dontcallme.ui.components.navigation.drawer.NaviItem;
import com.practice.dontcallme.ui.components.navigation.drawer.NaviMenu;
import com.practice.dontcallme.ui.util.UIUtils;
import com.practice.dontcallme.ui.util.css.FlexDirection;
import com.practice.dontcallme.ui.util.css.Overflow;
import com.practice.dontcallme.ui.views.Dashboard;
import com.practice.dontcallme.ui.views.Home;
import com.practice.dontcallme.ui.views.Inquiry;
import com.practice.dontcallme.ui.views.LoginView;
...
@PWA(name = "dontcallme IoT SSS Project", shortName = "dontcallme",
        description = "IoT Streaming Security Solution")
...
public class MainLayout extends FlexBoxLayout
    ...
    private void initNaviItems() {
        ...
        NaviItem personnel = menu.addNaviItem(VaadinIcon.USERS, "Personnel",
                null);
        menu.addNaviItem(VaadinIcon.DASHBOARD, personnel, "Dashboard", Dashboard.class);
        menu.addNaviItem(VaadinIcon.QUESTION, personnel, "Inquiry", Inquiry.class);
        NaviItem underConstruction = menu.addNaviItem(VaadinIcon.CLOSE_SMALL, "underConstruction",
                null);
        menu.addNaviItem(underConstruction, "CustomerTest", TestView.class);
        menu.addNaviItem(underConstruction, "LogIn", LoginView.class);
    }
